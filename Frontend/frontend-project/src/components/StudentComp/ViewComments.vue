  ...
  <div class="comments-container">
    ...
    <ul>
      <li v-for="comment in comments" :key="comment.id" class="comment-item">
        <p><strong>Topic:</strong> {{ comment.content }}</p>
    ...
    <button class="back-button" @click="returnToDashboard">Return to Dashboard</button>
  </div>
</template>
...
const fetchComments = async () => {
  await commentStore.fetchCommentsForStudent(); // Fetch comments for the logged-in student
